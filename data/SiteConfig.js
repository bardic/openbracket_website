module.exports = {
  ...
  blogAuthorId: "TJ Gillis", // The default and fallback author ID used for blog posts without a defined author.
  siteTitle: "Openbracket", // Site title.
 ...
 // Optional, the cover image used in header for home page. e.g: "/images/blog-cover.jpg",
  ...
  googleAnalyticsID: "UA-7292868-1", // GA tracking ID.
  disqusShortname: "openbracket-1",//"https-vagr9k-github-io-gatsby-advanced-starter", // enables Disqus comments, visually deviates from original Casper theme.
  siteSocialUrls: [
    "https://github.com/bardic",
    "https://twitter.com/tjgillis",
    "mailto:thomas.j.gillis@gmail.com"
  ],
  ...
  copyright: {
    label: "Openbracket" // Label used before the year
